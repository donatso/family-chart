...
export function calculateDelay(tree: FamilyTree, d: Pick<FamilyTreeNode,'is_ancestry' |'spouse' |'depth'> | Pick<TreeLink,'is_ancestry' |'spouse' |'depth'>, transition_time: number) {
