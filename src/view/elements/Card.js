...
<!--        <clipPath id="card_clip"><path d="${cardPath({w:card_dim.w, h:card_dim.h}, 15)}"></clipPath>-->
<!--        <clipPath id="card_text_clip"><rect width="${card_dim.w-card_dim.text_x-10}" height="${card_dim.h-10}"></rect></clipPath>-->
        <clipPath id="card_image_clip"><circle r="${card_dim.img_w/2}" cx="${card_dim.img_w/2}" cy="${card_dim.img_h/2}"></clipPath>
       </defs>
    `))

    function cardPath(dim, curve, ) {
      const {w,h} = dim
      const c = curve
