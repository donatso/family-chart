...
export default function updateCardsComponent(div: d3.BaseType, tree: FamilyTree, Card: (d: FamilyTreeNode) => (d3.BaseType | string), props: {initial?:boolean,transition_time?: number}= {}) {
