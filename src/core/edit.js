...
import { createHistory, createHistoryControls } from "../features/history"
...
EditTree.prototype.createHistory = function() {
  this.history = createHistory(this.store, this.getStoreDataCopy.bind(this), historyUpdateTree.bind(this))
  this.history.controls = createHistoryControls(this.cont.querySelector('.f3-nav-cont'), this.history)
